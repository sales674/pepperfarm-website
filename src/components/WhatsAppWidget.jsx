...
export default function WhatsAppWidget() {
    ...
    const handleOpen = (e) => {
      ...
      if (e.detail) {
        ...
        if (e.detail.item) {
          ...
          setMessage(`Hi Pepperfarm! I'm interested in the ${e.detail.item}${sizeStr}.`);
        }
      }
    };
  ...
  const handleWhatsApp = () => {
    const text = message || "Hi Pepperfarm! I'm interested in learning more about your healthy meal plans.";
        ...
        <div className="wa-modal-overlay" onClick={close}>
          <div className="wa-modal reveal active" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="wa-modal-options">
              ...
              <button onClick={handleLeaveDetails} className="wa-option-btn wa-option-form">
                ...
                <div>
                  ...
                  <span>Fill out a quick form</span>
                </div>
                <span className="wa-option-arrow">→</span>
              </button>
            </div>
